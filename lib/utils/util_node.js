  ...
  return {
    ...
    transIntoModelTreeNodeArr: function () {
      return function (data, arr) {
        var newModels = [];
        var newTreeNodeData = new TreeNode.ModelTreeNode(data);
    ...
    transIntoMaterialTreeNodeArr: function () {
      return function (data, arr) {
        var newMaterials = [];
        var newTreeNodeData = new TreeNode.MaterialTreeNode(data);
    ...
    recurseRawDataNode: function () {
      return function (data, arr, fn) {
        ...
        var len = data.length;
        for (var i = 0; i < len; i++) {
          var newTreeNodeData = fn(data[i], arr);
